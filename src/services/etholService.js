...
class EtholService {
    ...
    /**
     * Mengecek portal Ethol secara berkala (Random Check)
     */
    static async checkPortal(client) {
        ...
        try {
            ...
            if (daftarAbsenTerbuka && daftarAbsenTerbuka.length > 0) {
                for (let absen of daftarAbsenTerbuka) {
                    ...
                    if (isBaru) {
                        await this.announceAbsen(client, process.env.TARGET_GROUP_ID, absen.matkul, absen.tanggal);
